...
set_config (){
	...
	add_package luci-app-filebrowser luci-app-passwall luci-app-ttyd luci-app-wizard luci-app-taskplan \
			luci-app-ksmbd luci-app-miaplus luci-app-watchdog luci-theme-bootstrap luci-app-filebrowser-js \
			luci-app-diskman-js
...
clone_dir hong0980/build aria2 axel ddnsto deluge libtorrent-rasterbar lsscsi \
		...
		sunpanel transmission qBittorrent-static luci-app-filebrowser-js luci-app-diskman-js

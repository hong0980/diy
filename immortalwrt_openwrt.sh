...
set_config (){
	...
	add_package "autocore opkg luci-app-arpbind luci-app-ddnsto luci-app-ssr-plus luci-app-passwall luci-app-upnp luci-app-ttyd luci-app-timedtask luci-app-ksmbd luci-app-wizard" luci-app-easymesh
}
...
clone_dir hong0980/build luci-app-ddnsto luci-app-diskman luci-app-dockerman \
	...
	luci-app-timedtask luci-app-tinynote luci-app-wizard luci-app-easymesh luci-lib-docker lsscsi \
...
if [[ $REPO_BRANCH =~ master|23|24 ]]; then
	...
	add_package "luci-app-gecoosac luci-app-partexp"

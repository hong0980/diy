...
set_config (){
	...
	case "$TARGET_DEVICE" in
		...
		360T7|h3c-nx30-pro|xiaomi-ax3000t)
			...
			add_package "luci-app-mesh-node libustream-mbedtls luci-app-nikki luci-app-fchomo luci-i18n-clashoo-zh-cn luci-app-clashoo luci-app-mesh11sd"
	...
	[[ $TARGET_DEVICE =~ k2p|d2|nx30|ax3000t ]] || add_package \
		...
		luci-app-miaplus luci-app-watchdog luci-app-fchomo luci-i18n-clashoo-zh-cn luci-app-clashoo
...
clone_dir hong0980/build aria2 axel ddnsto deluge lsscsi libtorrent-rasterbar \
		...
		luci-app-mesh-node luci-app-nikki #mihomo
...
clone_dir sbwml/openwrt_helloworld kcptun xray-core
...
clone_dir Openwrt-Passwall/openwrt-passwall-packages chinadns-ng geoview simple-obfs \
